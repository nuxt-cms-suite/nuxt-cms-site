...
import DekstopNavbarItem from "./dekstop/navbar-item";
...
const RenderDekstopNavbarItems = defineComponent({
  name: "RenderDekstopNavbarItems",
  props: {
    linkItems: {
  ...
  render(){
    ...
    return this.$props.linkItems.map((linkItem, index) => {
      // console.log(hasChildren(index));
      if(hasChildren(index)) {
        return;
      }
      return <DekstopNavbarItem item={linkItem}/>
    })
  }
})
      ...
      <header class="bg-white font-roboto-condensed">
        ...
        >
          ...
          <div class="hidden lg:flex lg:gap-x-12">
            ...
            <RenderDekstopNavbarItems linkItems={this.links}/>
          </div>
